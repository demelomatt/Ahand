...
class UIFunctions(Ui_MainWindow):
    ...
    def dropPdf(self,paths):
        ...
        if pageID == 0:
            ...
            label = self.ui.label_drop_export
            UIFunctions.inputPdfPaths_export = paths
            lineEdit_output = self.ui.lineEdit_outputPath_export
            lineEdit_filename = self.ui.lineEdit_filename_export
    ...
    def removeColumn(self,table):
        columnCount = table.columnCount()
        table.removeColumn(columnCount - 1)
